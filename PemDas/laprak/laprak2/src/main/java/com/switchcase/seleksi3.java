...
public class seleksi3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("5. Riyal - Arab Saudi (kurs Riyal 1 = Rp 1100,-)");
        System.out.println("Masukkan jenis mata uang anda: ");
        int pilihan = in.nextInt();

        switch (pilihan) {
            case 1:
                System.out.println("Data Diterima, jenis valuta Anda: Dolar Amerika Serikat");
                System.out.println("Masukkan banyak uang anda (dalam dolar): ");
                uang = in.nextInt();
                System.out.println("Uang yang diterima: Rp " + (uang * 8000) + ",-");
                break;
            case 2:
                System.out.println("Data Diterima, jenis valuta Anda: Yen Jepang");
                System.out.println("Masukkan banyak uang anda (dalam Yen): ");
                uang = in.nextInt();
